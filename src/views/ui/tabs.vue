    ...
    <PageHeader :title="title" :items="items" />
     <div class="row">
                            ...
                            <div class="col-xxl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <p class="text-muted">Use <code>&lt;b-nav tabs justified&gt;</code> class to generate equal-width elements with all horizontal space will be occupied by nav links.</p>
                                        <!-- Nav tabs -->
                        ...
                        <div class="row">
                            <div class="col-xxl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <p class="text-muted">Use <code>&lt;b-nav card-header pills&gt;</code> class to generate particular selected nav links without borders.</p>
                                        <!-- Nav tabs -->
                            ...
                            <div class="col-xxl-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <p class="text-muted">Use <code>&lt;b-nav card-header pills justified&gt;</code> class to generate equal-width elements without borders, all horizontal space will be occupied by nav links.</p>                                        
                                        <!-- Nav tabs -->
